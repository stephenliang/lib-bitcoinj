 ...
 */
public class CryptoConnectionManagerTest {
    private CryptoConnectionManager cryptoConnectionManager;
    private CommandFactory commandFactory;

    @Before
    public void setUp() {
        commandFactory = new CommandFactory();
        cryptoConnectionManager = new CryptoConnectionManager("72.233.92.90", 8333, CryptoCurrency.BITCOIN, commandFactory);
    }
